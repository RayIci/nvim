...
## Purpose
Test running via neotest: a subsystem set up alongside the other plugins, receiving per-language adapters from language packs, plus a which-key keymap tree for running, debugging, navigating, and watching tests.
